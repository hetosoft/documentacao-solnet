...
Quando uma NF-e baixada já foi importada como **entrada** na movimentação (via [Importar XML](../Movimentacao/documentacao_importar_xml.md) ou lançada manualmente), o Sol.NET cria o vínculo automaticamente. Esse vínculo aparece de duas formas:
